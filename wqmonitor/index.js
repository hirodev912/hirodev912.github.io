                ...
                area.City.forEach((city, citynum) => {
                    city.IntensityStation.forEach((int, intnum) => {
                        ...
                        if (prefnum == 0 && areanum == 0 && citynum == 0 && intnum == 0) {
                            ...
                            const wavemarker = L.divIcon({
                                iconSize: [2, 2],
                                iconAnchor: [1, 1],
                                html: '<div class="hypomarker"></div>'
                            });
                            ...
                            L.marker([r.Body.Earthquake.Hypocenter.Area.Coordinate.substr(1, 4), r.Body.Earthquake.Hypocenter.Area.Coordinate.substr(6, 5)], { icon: wavemarker, zIndexOffset: 9998 }).addTo(iconlayer);
                        }
                    });
                });
            });
